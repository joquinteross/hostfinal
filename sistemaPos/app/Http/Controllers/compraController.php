...
class compraController extends Controller
{
    ...
    public function store(StoreCompraRequest $request)
    {
        ...
        try {
            ...
            $arrayPrecioCompra = $request->get('arrayprecioventa');
            ...
            while ($cont < $siseArray) {
                $compra->productos()->syncWithoutDetaching([
                    $arrayProducto_id[$cont] => [
                        ...
                        'precio_venta' => $arrayPrecioCompra[$cont]
                    ]
                ]);
    ...
    {
    $compra = Compra::with(['proveedore.persona', 'comprobante', 'productos'])->findOrFail($id);

    $pdf = Pdf::loadView('compra.factura', compact('compra'));

    return $pdf->stream("factura_compra_{$compra->id}.pdf");
    }
}
